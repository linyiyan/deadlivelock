...
ocamlc -I $MYINCLUDE -I ../ocamlgraph/src -I ../ocamlgraph/lib -ccopt -L$MYINCLUDE -ccopt -L../ocamlgraph/src -ccopt -L../ocamlgraph/lib -c lockset.ml $MAINFILE.ml
ocamlc -o $MAINFILE unix.cma str.cma nums.cma $MYINCLUDE/cil.cma ../ocamlgraph/graph.cma lockset.cmo $MAINFILE.cmo